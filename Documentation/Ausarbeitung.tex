...
Hierbei ist $x$ die Menge der zu berechnenden Datensätze bestehend aus den 2-Tupeln $(r_{1},r_{2})$, wobei $r_{1}$ den Radius der inneren Kugel, $r_{2}$ den der äußeren Kugel bezeichnet.
