...
In der von uns enwickelten Lösung verwenden wir die Vector Floating Point Erweiterung das ARM-Prozessors. 
...
zu profitieren. Das bedeutet, dass pro Assemblerbefehl nicht mit einem, sondern mit bis zu vier Zahlen gleichzeitig gerechnet werden kann. Unsere Tests haben gezeigt, dass dadurch die Berechnung mindestens um den Faktor 6 beschleunigt wird.
