...
Abschließend kann man sagen, dass die NEON-Implementierung zwar mit Abstand am schnellsten ist. Jedoch treten kleine Ungenauigkeiten auf, die durch die Tatsache hervorgerufen werden, dass der NEON-Befehlssatz keine direkte Division ermöglicht und man mit einer Annäherung an den Kehrbruch arbeiten muss. Da sich die Abweichungen jedoch nicht wirklich bemerkbar machen und die Ergebnisse auf mehrere Stellen genau sind, ist diese Implementieren wohl die am geeignetsten. 
\end{document}
